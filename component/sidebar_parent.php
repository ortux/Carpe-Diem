...
<aside id="default-sidebar"
        ...
        <div class="h-full px-4 py-6 overflow-y-auto">
            ...
            <div class="flex flex-col items-center justify-center mb-8">
                ...
                <h5 class="text-sm text-gray-200 mt-1">Hello, Parent Of
            ...
            <ul class="space-y-4">
                ...
                <!-- Settings Section -->
                <div class="mt-8">
                    <p class="text-sm text-gray-300 uppercase font-semibold mb-3">Profiles</p>
                    <ul class="space-y-4">
                        <li>
                            <a href="index.php"
                                ...
                                <span class=" ml-3">View Another Children</span>
                            </a>
                        </li>
