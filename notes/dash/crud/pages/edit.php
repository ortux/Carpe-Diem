...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "UPDATE users SET email = '$email', class = '$class', is_verified = $is_verified";
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="class" id="class" required
                            class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option value="10" <?php echo $user['class']=='10' ? 'selected' : '' ; ?>>Class 10</option>
                    ...
                    <div class="mb-6">
                        <label class="flex items-center">
                            ...
                            <span class="ml-2 text-gray-700">Verified User</span>
                        </label>
                    </div>
