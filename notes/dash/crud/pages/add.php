...
<?php
session_start();
//$db = new mysqli('localhost', 'username', 'password', 'vcluygjj_new_website');
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $conn->query("INSERT INTO users (email, password, class, is_verified) VALUES ('$email', '$password', '$class','1')");
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <select name="class" id="class" required
                            ...
                            <option value="10">Class 06</option>
                            <option value="11">Class 07</option>
                            <option value="12">Class 08</option>
                            <option value="12">Class 09</option>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="../user_management.php" class="text-gray-600 hover:text-gray-800">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
